	...
	<div class="col-md-12">
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<div class="page-heading"> <i class="glyphicon glyphicon-edit"></i> Manage Books</div>
			</div> <!-- /panel-heading -->
			<div class="panel-body">
				...
				<div class="div-action pull pull-right" style="padding-bottom:20px;">
					<button class="btn btn-default button1" data-toggle="modal" id="addProductModalBtn" data-target="#addProductModal"> <i class="glyphicon glyphicon-plus-sign"></i> Add Book </button>
				</div> <!-- /div-action -->				
    	...
    	<form class="form-horizontal" id="submitProductForm" action="php_action/createProduct.php" method="POST" enctype="multipart/form-data">
	      ...
	      <div class="modal-body" style="max-height:450px; overflow:auto;">
	      	...
	      	<div class="form-group">
	        	<label for="productImage" class="col-sm-3 control-label">Book Image: </label>
	        ...
	        <div class="form-group">
	        	<label for="productName" class="col-sm-3 control-label">Book Name: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
	        ...
	        <div class="form-group">
	        	<label for="brandName" class="col-sm-3 control-label">Publication/Edition: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
...
<div class="modal fade" id="editProductModal" tabindex="-1" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
	      ...
	      <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	        <h4 class="modal-title"><i class="fa fa-edit"></i> Edit Book</h4>
	      </div>
	      <div class="modal-body" style="max-height:450px; overflow:auto;">
	      	...
	      	<div class="div-result">
				  ...
				  <ul class="nav nav-tabs" role="tablist">
				    ...
				    <li role="presentation"><a href="#productInfo" aria-controls="profile" role="tab" data-toggle="tab">Book Info</a></li>    
				  </ul>
				  ...
				  <div class="tab-content">
				    ...
				    <div role="tabpanel" class="tab-pane active" id="photo">
				    	...
				    	<div class="form-group">
			        	<label for="editProductImage" class="col-sm-3 control-label">Book Image: </label>
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">							    				   
				    ...
				    <div role="tabpanel" class="tab-pane" id="productInfo">
				    	...
				    	<div class="form-group">
			        	<label for="editProductName" class="col-sm-3 control-label">Book Name: </label>
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
			        ...
			        <div class="form-group">
			        	<label for="editBrandName" class="col-sm-3 control-label">Publication/Edition: </label>
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeProductModal">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title"><i class="glyphicon glyphicon-trash"></i> Remove Book</h4>
      </div>
